        ...
        <>
            ...
            <div className='flex justify-center items-center h-screen bg-gradient-to-b from-mainSecondColor to-mainColor'>
                {loading ? (
                    ...
                    <div className="bg-slate-50 min-h-[450px] min-w-[300px] rounded-lg flex flex-col items-center justify-around">
                        <img src={userProfileData?.ProfileImage} className="w-[120px] rounded-xl" alt="" />
                        <div className="flex flex-col items-center">
                            {editMode ? (
                                <form onSubmit={updateUserProfileData}>
                                    <input type="text" value={userProfileData?.Name} name="name" className="bg-slate-200 px-4 py-2 rounded-lg mt-5" />
                                    <input type="email" name="email" value={userProfileData?.Email} className="bg-slate-200 px-4 py-2 rounded-lg mt-2" />
